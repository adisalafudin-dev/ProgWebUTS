    ...
    <div className="flex h-full flex-col">
      ...
      <div className="border-t border-white/10 p-4">
        ...
        <Link
          to="/"
          onClick={() => onClose?.()}
          className="mb-2 flex w-full items-center justify-center gap-2 rounded-xl border border-white/10 px-4 py-2.5 text-sm font-semibold text-slate-200 transition-colors duration-200 hover:bg-white/5"
        >
        ...
        <button
          type="button"
          onClick={onLogout}
          className="w-full rounded-xl bg-amber-600 px-4 py-2.5 text-sm font-semibold text-white transition-colors duration-200 hover:bg-amber-500"
        >
          Keluar
        </button>
      </div>
