        ...
        <div className="flex flex-col items-center text-center">
          ...
          {category.bookCount > 0 && (
            <div className="mb-4 rounded-xl bg-amber-50 p-3 text-xs text-amber-800 border border-amber-200 text-left flex items-start gap-2">
              <Icon name="info" className="h-4 w-4 text-amber-600 flex-shrink-0 mt-0.5" />
              <span>
                Kategori ini saat ini memiliki{" "}
                <strong>{category.bookCount} buku</strong> yang terdaftar.
                Menghapus kategori ini dapat membuat buku kehilangan penataan kategori.
              </span>
            </div>
          )}
